...
- [ ] Trancher le lien Drive cassé (1/43 images, fichier probablement supprimé) avant de patcher la carte
- [ ] Patcher la carte avec les 42 nouvelles URLs Cloudinary (migration Drive → Cloudinary)
